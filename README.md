...
A decentralised stable coin which is similar to bitcoin or usd, but no fluctuation of its value takes place , it means the value of the coin will be permanatly fixed.
...
- [ DeFi Stablecoin](#foundry-defi-stablecoin)
- [About](#about)
...
```
git clone https://github.com/pochsid/decentralized-exchange.git
